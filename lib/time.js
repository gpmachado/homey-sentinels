...
// "2026-09-23 10:14:14" in the given time zone: readable, unambiguous (year first) and sortable. The
// `timestamp` Flow tokens are ISO strings in UTC ("...T13:14:14.591Z"), fine for a script but wrong to
// drop into a timeline entry; this is the one to show a person.
function localTimeText(time, timeZone) {
...
module.exports = { localTimeText, startOfLocalDay, recentLocalDayStarts, timezoneOffsetMinutes, localDateKey, isValidTimeZone };
